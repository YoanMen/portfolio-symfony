 ...
 */
final class Version20240603065053 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE link_project (link_id INT NOT NULL, project_id INT NOT NULL, INDEX IDX_52D58A1BADA40271 (link_id), INDEX IDX_52D58A1B166D1F9C (project_id), PRIMARY KEY(link_id, project_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
