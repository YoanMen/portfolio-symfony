 ...
 */
final class Version20240601120241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project_icon_project (project_icon_id INT NOT NULL, project_id INT NOT NULL, INDEX IDX_A72B6F9DC2A7DB57 (project_icon_id), INDEX IDX_A72B6F9D166D1F9C (project_id), PRIMARY KEY(project_icon_id, project_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
