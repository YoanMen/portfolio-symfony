 ...
 */
final class Version20240530200719 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE auth_attempt (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, attempt INT NOT NULL, ip VARCHAR(120) DEFAULT NULL, attempt_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', UNIQUE INDEX UNIQ_56C82295A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
